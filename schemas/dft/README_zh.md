...
| license | string | object | 数据源记录的“license”字段；应结合本类别中的其他字段使用。 |
| citation | string | object | 数据源记录的“citation”字段；应结合本类别中的其他字段使用。 |
...
| volume | float | varies | 数据源记录的“volume”字段；应结合本类别中的其他字段使用。 |
| density | float | varies | 数据源记录的“density”字段；应结合本类别中的其他字段使用。 |
...
| energy_cutoff | float | varies | 数据源记录的“energy cutoff”字段；应结合本类别中的其他字段使用。 |
...
| u_values | object | - | 数据源记录的“u values”字段；应结合本类别中的其他字段使用。 |
| theoretical | boolean | - | 数据源记录的“theoretical”字段；应结合本类别中的其他字段使用。 |
| temperature | float | varies | 数据源记录的“temperature”字段；应结合本类别中的其他字段使用。 |
| pressure | float | varies | 数据源记录的“pressure”字段；应结合本类别中的其他字段使用。 |
...
| total_energy | float | varies | 数据源记录的“total energy”字段；应结合本类别中的其他字段使用。 |
| uncorrected_energy | float | varies | 数据源记录的“uncorrected energy”字段；应结合本类别中的其他字段使用。 |
| energy_per_atom | float | varies | 数据源记录的“energy per atom”字段；应结合本类别中的其他字段使用。 |
| formation_energy | float | varies | 数据源记录的“formation energy”字段；应结合本类别中的其他字段使用。 |
| formation_energy_per_atom | float | varies | 数据源记录的“formation energy per atom”字段；应结合本类别中的其他字段使用。 |
| energy_above_hull | float | varies | 数据源记录的“energy above hull”字段；应结合本类别中的其他字段使用。 |
| decomposition_energy | float | varies | 数据源记录的“decomposition energy”字段；应结合本类别中的其他字段使用。 |
| equilibrium_reaction_energy | float | varies | 数据源记录的“equilibrium reaction energy”字段；应结合本类别中的其他字段使用。 |
...
| uncorrected_energy_per_atom | float | varies | 数据源记录的“uncorrected energy per atom”字段；应结合本类别中的其他字段使用。 |

## 电子结构

| 字段 | 类型 | 单位 | 含义 |
| --- | --- | --- | --- |
| band_gap | float | varies | 数据源记录的“band gap”字段；应结合本类别中的其他字段使用。 |
...
| cbm | float | varies | 数据源记录的“cbm”字段；应结合本类别中的其他字段使用。 |
| vbm | float | varies | 数据源记录的“vbm”字段；应结合本类别中的其他字段使用。 |
| fermi_level | float | varies | 数据源记录的“fermi level”字段；应结合本类别中的其他字段使用。 |
...
| dos_energy_up | array | varies | 数据源记录的“dos energy up”字段；应结合本类别中的其他字段使用。 |
| dos_energy_down | array | varies | 数据源记录的“dos energy down”字段；应结合本类别中的其他字段使用。 |
...
| total_magnetization | float | - | 数据源记录的“total magnetization”字段；应结合本类别中的其他字段使用。 |
| magnetization_per_atom | float | - | 数据源记录的“magnetization per atom”字段；应结合本类别中的其他字段使用。 |
...
| 字段 | 类型 | 单位 | 含义 |
| --- | --- | --- | --- |
| bulk_modulus_voigt | float | varies | 数据源记录的“bulk modulus voigt”字段；应结合本类别中的其他字段使用。 |
| bulk_modulus_reuss | float | varies | 数据源记录的“bulk modulus reuss”字段；应结合本类别中的其他字段使用。 |
| bulk_modulus_vrh | float | varies | 数据源记录的“bulk modulus vrh”字段；应结合本类别中的其他字段使用。 |
| shear_modulus_voigt | float | varies | 数据源记录的“shear modulus voigt”字段；应结合本类别中的其他字段使用。 |
| shear_modulus_reuss | float | varies | 数据源记录的“shear modulus reuss”字段；应结合本类别中的其他字段使用。 |
| shear_modulus_vrh | float | varies | 数据源记录的“shear modulus vrh”字段；应结合本类别中的其他字段使用。 |
| youngs_modulus | float | varies | 数据源记录的“youngs modulus”字段；应结合本类别中的其他字段使用。 |
...
| elastic_tensor | array | - | 数据源记录的“elastic tensor”字段；应结合本类别中的其他字段使用。 |
...
| weighted_surface_energy | float | varies | 数据源记录的“weighted surface energy”字段；应结合本类别中的其他字段使用。 |
| surface_energy | float | varies | 数据源记录的“surface energy”字段；应结合本类别中的其他字段使用。 |
| surface_anisotropy | float | - | 数据源记录的“surface anisotropy”字段；应结合本类别中的其他字段使用。 |
| weighted_work_function | float | varies | 数据源记录的“weighted work function”字段；应结合本类别中的其他字段使用。 |
| work_function | float | varies | 数据源记录的“work function”字段；应结合本类别中的其他字段使用。 |
| grain_boundaries | object | - | 数据源记录的“grain boundaries”字段；应结合本类别中的其他字段使用。 |
| weighted_surface_energy_ev_per_ang2 | float | varies | 数据源记录的“weighted surface energy ev per ang2”字段；应结合本类别中的其他字段使用。 |
...
| debye_temperature | float | varies | 数据源记录的“debye temperature”字段；应结合本类别中的其他字段使用。 |
...
| properties_requested | boolean | object | 数据源记录的“properties requested”字段；应结合本类别中的其他字段使用。 |
